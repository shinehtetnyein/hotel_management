...
$(document).ready(function () {
    $("#nav-sm-toggle").click(function () {
        console.log("hay i am working");
        let mainBanners = document.querySelector(".main_banners");
        // console.log(mainBanners);
        if (mainBanners.style.display === "none") {
            mainBanners.style.display = "block";
        } else {
            mainBanners.style.display = "none";
        }
    });
...
getheader.style.backgroundImage = `url(./images/banner/banner${
    getgen.next().value
}.jpg)`;
