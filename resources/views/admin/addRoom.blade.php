...
@section('content')
    ...
    <form action="{{ route('addNewRoom') }}" style="padding:10px; width:400px; margin:auto;" method="POST"
        ...
        <div class="mb-2">
            ...
            <input type="text" class="form-control" id="roomNo" name="room_no" value="">
        </div>
        <div class="mb-2">
            <label for="roomTitle" class="form-label">Room Title</label>
            <input type="text" class="form-control" id="roomTitle" name="room_title" value="">
        </div>
        <div class="mb-2">
            <label for="roomType" class="form-label">Room Type</label>
            <input type="text" class="form-control" id="roomType" name="room_type" value="">
        </div>
        <div class="mb-2">
        ...
        <div class="mb-2">
            ...
            <textarea class="border border-2" name="desc" id="desc" cols="44" rows="10"></textarea>
        </div>
