    ...
    <body>
        ...
        <section class="mb-5 m-sm-auto">
            <div class="service_sections">
                ...
                <!-- End title -->
                <div class="d-lg-flex justify-content-center services_rooms">
        ...
        <section>
            <div id="premises" class="py-5">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul id="lightslider" class="light-sliders sm-light-slider">
                        ...
                        <ul id="sm-lightslider" class="light-sliders sm-light-slider">
                            <li><img src="./images/gallery1.jpg" alt="01"></li>
                            <li><img src="./images/gallery2.jpg" alt="02"></li>
                            <li><img src="./images/gallery3.jpg" alt="01"></li>
                            <li><img src="./images/gallery4.jpg" alt="02"></li>
